...
export function getIndexFormat(inp) {
    /**
     * converts:
...
export function getSnippets(str) {
    let start = 0;
...
export function getWhitespaceSanitized(str) {
    return str.replace(/\s+/g, ' ').trim();
}
export function getIndexList(str) {
