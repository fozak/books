...
export class StockLedger extends Report {
    ...
    _convertRawDataRowToReportRow(row, colouredMap) {
        const cells = [];
...
StockLedger.title = t `Stock Ledger`;
StockLedger.reportName = 'stock-ledger';
StockLedger.isInventory = true;
//# sourceMappingURL=StockLedger.js.map