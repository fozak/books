...
export class Main {
    constructor() {
        this.title = 'Frappe Books';
        this.winURL = '';
        this.checkedForUpdate = false;
        this.mainWindow = null;
        this.WIDTH = 1200;
        this.HEIGHT = process.platform === 'win32' ? 826 : 800;
    ...
    setMainWindowListeners() {
        ...
        this.mainWindow.webContents.on('did-fail-load', () => {
            this.mainWindow.loadURL(this.winURL).catch((err) => emitMainProcessError(err));
        });
    }
}
/**
 ...
 * protocol.
 */
function bufferProtocolCallback(request, callback) {
