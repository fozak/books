...
export default function registerProcessListeners(main) {
    ...
    process.on(CUSTOM_EVENTS.MAIN_PROCESS_ERROR, (error, more) => {
        main.mainWindow.webContents.send(IPC_CHANNELS.LOG_MAIN_PROCESS_ERROR, error, more);
    });
...
//# sourceMappingURL=registerProcessListeners.js.map