...
export function getUrlAndTokenString() {
    ...
    const empty = { errorLogUrl: '', telemetryUrl: '', tokenString: '' };
    let errLogCredsPath = path.join(process.resourcesPath, '../creds/log_creds.txt');
...
export async function sendError(body, main) {
...
//# sourceMappingURL=contactMothership.js.map