...
export default function registerIpcRendererListeners() {
    ipc.registerMainProcessErrorListener((_, error, more) => {
        ...
        more.notifyUser ?? (more.notifyUser = true);
    ...
    ipc.registerConsoleLogListener((_, ...stuff) => {
...
//# sourceMappingURL=registerIpcRendererListeners.js.map