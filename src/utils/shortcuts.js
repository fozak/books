var _Shortcuts_instances, _Shortcuts_trigger;
import { __classPrivateFieldGet } from "tslib";
import { watch } from 'vue';
import { getIsMac } from './misc';
const mods = ['alt', 'ctrl', 'meta', 'repeat', 'shift'];
/**
...
export class Shortcuts {
    constructor(keys) {
        ...
        watch(this.keys, (keys) => {
            ...
            __classPrivateFieldGet(this, _Shortcuts_instances, "m", _Shortcuts_trigger).call(this, key);
        });
    }
    /**
     ...
     */
    set(context, shortcut, callback, propagate = false, removeIfSet = true) {
        const key = this.getKey(shortcut);
        if (!key) {
            return;
        }
...
_Shortcuts_instances = new WeakSet(), _Shortcuts_trigger = function _Shortcuts_trigger(key) {
