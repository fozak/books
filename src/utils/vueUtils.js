...
import { commonDocCancel, commonDocSubmit, commonDocSync, commongDocDelete, showCannotCancelOrDeleteToast, showCannotSaveOrSubmitToast, } from './ui';
...
export function useDocShortcuts(shortcuts, docRef, name, isMultiple = true) {
    let context = name;
    if (isMultiple) {
...
//# sourceMappingURL=vueUtils.js.map