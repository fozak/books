...
test('importer init', (t) => {
    ...
    t.equal(typeof importer.getCSVTemplate(), 'string', 'csv template is a string');
    t.end();
});
...
test('import SalesInvoices', async (t) => {
    ...
    t.ok(names.every((n) => n?.startsWith('SINV-')), 'numberSeries assigned');
});
closeTestFyo(fyo, __filename);
//# sourceMappingURL=testImporter.spec.js.map