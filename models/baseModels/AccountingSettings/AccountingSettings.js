...
export class AccountingSettings extends Doc {
    ...
    async change(ch) {
        ...
        if (ch.changed == 'enablePointOfSaleWithOutInventory' &&
            this.enablePointOfSaleWithOutInventory) {
            const inventorySettings = (await this.fyo.doc.getDoc(ModelNameEnum.InventorySettings));
...
AccountingSettings.lists = {
    country: () => Object.keys(getCountryInfo()),
};
//# sourceMappingURL=AccountingSettings.js.map